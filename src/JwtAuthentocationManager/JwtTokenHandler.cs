...
namespace JwtAuthentocationManager
{
    public class JwtTokenHandler
    {
        ...
        public JwtTokenHandler()
        {
            ...
            {
                new UserAccount{UserName = "admin", Password="admin123", Role="Manager"},
                new UserAccount { UserName = "user01", Password = "user01", Role = "TeamMember" }
        ...
        public AuthenticationResponse GenerateJwtToken(AuthenticationRequest authenticationRequest)
        {
            ...
            var claimsIdentity = new ClaimsIdentity(new List<Claim>
            {
                ...
                new Claim((string)ClaimTypes.Role, userAccount.Role)
            });
            ...
            var securityToken = jwtSecuirtyTokenHandler.CreateToken(securityTokenDescriptor);
            var token = jwtSecuirtyTokenHandler.WriteToken(securityToken);
